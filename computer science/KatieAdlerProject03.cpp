...
int den; // deninator of the fraction
  
int gcd();
// A prvate function that is used to find the gcd of numerator
// and deninator by using Euclidean Algorithm
};
...
{
// return the deninator of the fraction
   return den;
}
...
{
cout << "The constructor with two argument was wrong. Make sure that the denunator always positive.\n";
result -= 0.5;
}
// finish test
